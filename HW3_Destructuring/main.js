...
const allClienst = [...clients1, ...clients2];
const allClienstFilter = allClienst.filter((client, index, self) => {
  return self.indexOf(client) === index;
});
console.log(allClienst);
console.log(allClienstFilter);
...
divTask.classList.add("task3");
divTask.innerHTML = `Name: ${name}, Age: ${years}, Is Admin: ${isAdmin}`;
document.body.insertAdjacentElement("afterbegin", divTask);
//
